...
import IssuePage from "./components/Repository/IssuePage";
import RepoPage from "./components/Repository/RepoPage.jsx";
import AllPrograms from "./components/Contests/Programs/AllPrograms.jsx";
import ProgramPage from "./components/Contests/Programs/ProgramPage.jsx";
function Logout() {
  ...
  createRoutesFromElements(
    <Route errorElement={<ErrorPage />}>
      <Route path="/" element={<Layout />}>
        ...
        {/*Repo routes start*/}
        <Route path="get/repo" element={<Repository />} />
        <Route path="get/repo-body/:id" element={<RepoPage />} />
        <Route path="get/issue-body/:id" element={<IssuePage />} />
        {/*Repo route ends */}
      ...
      <Route path="/repo" element={<Layout />} >

        <Route path=":owner/:repo" element={<RepoPage />} />
        <Route path=":owner/:repo/issue/:issueNumber" element={<IssuePage />} />
      </Route>
      {/* </Route> */}
      <Route
        path="/u/:username"

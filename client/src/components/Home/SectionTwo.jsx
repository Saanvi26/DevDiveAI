    ...
    <div className="max-md:mt-2 md:mt-24 flex justify-center p-2 min-h-screen min-xs:flex-col mx-auto w-11/12">
      <div className="h-5/6 dynamicprofile rounded-lg flex-col my-auto py-4 px-4 max-w-7xl lg:w-10/12">
        <div className="left text-center">
          <div className="sm:text-center max-sm:text-center">
            <h2 className="max-md:text-4xl md:text-6xl font-['Geist'] my-0 text-white font-semibold">
              Build your <span className="text-purple-500 px-2 ">Dynamic</span>{" "}
              Profile
            </h2>
              ...
              <div>
                <div className="flex flex-row bg-toolbar rounded-t-lg">
                  ...
                  <div className="bg-window text-[#B7B6FF] rounded-full text-sm tracking-wide flex justify-center w-full py-0.5 my-2 items-center">
                    <a className="py-1" href="/u/dashboard">https://repoOS.com/u/dashboard</a>
                  </div>
        ...
        <div className="flex justify-center m-4">
          <a href="/signup" className="btn px-5 py-2 bg-purple-500 border-purple-500 hover:bg-purple-600 text-lg text-white font-medium duration-75 rounded-2xl border ">
            Create Now
          </a>
        </div>
      </div>

...
import Contributors from "./Contributors";
import MuiTimeline from "./Timeline";
import { about_us } from "./assets/assets"; // Assuming you have an image for the repository suggesting website
  ...
  return (
    <>
      ...
      <div className="w-11/12 mx-auto text-center mt-4 antialiased font-outfit">
              ...
              <div className="w-full flex flex-row justify-between  text-white phone:mt-[80px] max-phone:mt-4">
                <div className="flex flex-col lg:max-w-[50%] text-left">
                  <div className="mb-[50px]">
                    <div className="heading mb-8 w-fit">
                      <h1 className="mt-2 text-white max-md:text-4xl md:text-6xl">
                        <span>Repository Suggester</span>
                      </h1>
                      <h3 className="text-left text-custom-blue">
                        Your Personalized GitHub Repository Suggestions!
                      </h3>
                    </div>
                    <p className="text-[20px]">
                      Explore a curated selection of GitHub repositories tailored
                      to your interests and preferences. Whether you're into web
                      development, machine learning, or other domains, we've got
                      the repositories that match your coding style.
                    </p>
                  </div>
                  <div className="">
                    <h2 className="mb-[18px] font-semibold text-5xl">
                    ...
                    <p className="text-[20px]">
                      Our mission is to simplify your GitHub exploration
                      experience by providing personalized repository
                      suggestions. Discover new projects, contribute, and expand
                      your coding horizons effortlessly.
                    </p>
                  </div>
                </div>
                <div className="lg:w-[50%] h-full lg:flex justify-end max-lg:hidden">
                  <img src={about_us} className="object-contain h-[525px]" alt="" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="stats stats-vertical lg:stats-horizontal shadow">
          <div className="stat">
            {/* Stat components similar to the original About component */}
          </div>
          {/* Additional stats components if needed */}
        </div>

        <div className="sm:w-10/12 mx-auto">
          <h1 className="w-full text-left py-2 mb-4 text-white"></h1>
          <div className="parts flex sm:flex-row text-left max-sm:flex-col">
            {/* Steps on how users can use the repository suggesting website */}
          </div>
        </div>
      </div>
      <div className="divider w-0"></div>
      {/* Footer or any additional components */}
    </>
  );
}
